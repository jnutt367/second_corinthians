...
<link
    ...
    <iframe width="100%" height="300" src="https://www.youtube.com/embed/jgYZdGXtLzw?si=WqYmstTRYsVmp-Lt&autoplay=1&mute=1" title="YouTube video player" frameborder="10" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                               
            </div>

   <p className={styles.parables}>"For I testify that they gave as much as they were able, and even beyond their ability."</p>
...
<p>Give</p>
 ...
 <iframe width="100%" height="315" src="https://www.youtube.com/embed/3lfPK2vfC54?autoplay=1&mute=1" title="YouTube video player" frameborder="10" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe> 
          </div>                         
...
<main id="second_thessalonians" className={styles.main}>
    ...
    <p className={styles.parables}>
          ...
          "The lawless one will be revealed, whom the Lord Jesus will overthrow with the breath of his mouth..."
</p>                                                      
  ...
  <p>Prev<p/>
      ...
      <a href="https://cash.app/$JNutt367">
         ...
         <a href="https://matthew-coral.vercel.app/#first_timothy">
               ...
               <div className={styles.iframe}> 
<iframe width="100%" height="315" src="https://www.youtube.com/embed/kbPBDKOn1cc?autoplay=1&mute=1" title="YouTube video player" frameborder="5" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>                         
                                  </div>
                                  
                              
        <div className={styles.grid2}>
          <div className={styles.card2}>
           <h2  className={styles.chapter2}>II Thessalonians Chapter I</h2>
            <p> 
          ...
          <div className={styles.card2}>
            <h2 className={styles.chapter2}>II Thessalonians Chapter II</h2>
            <p> 
          ...
          >
            <h2 className={styles.chapter2}>II Thessalonians Chapter III </h2>
            <p>
